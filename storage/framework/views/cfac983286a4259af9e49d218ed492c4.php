    ...
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm fixed-top">
            <div class="container"><a class="navbar-brand d-flex align-items-center" href="/"><img
                        src="<?php echo e(asset('images/logo_ksop.png')); ?>" alt="KSOP Logo" height="40"
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto align-items-center">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">About Us</a></li><?php if(auth()->guard()->check()): ?><li
                            class="nav-item ms-lg-3"><a href="<?php echo e(url('/dashboard')); ?>"
                        class="btn btn-primary">Dashboard</a></li><?php endif; ?>
                    </ul>
                </div>
            </div>
        </nav>
                        ...
                        <div class="login-card">
                            <div id="login-form">
                                ...
                                <p class="text-center mt-3 mb-0">
                                    Belum punya akun?
                                    <a href="<?php echo e(route('register')); ?>">Daftar Sini</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    ...
                    <div class="col-lg-6 d-flex align-items-center justify-content-center">
                        <img src="<?php echo e(asset('images/ilustrasi.jpg')); ?>" alt="Ilustrasi Sistem Maritim"
...
</html><?php /**PATH C:\PKL\sistem_kejadian_awal\resources\views/welcome.blade.php ENDPATH**/ ?>