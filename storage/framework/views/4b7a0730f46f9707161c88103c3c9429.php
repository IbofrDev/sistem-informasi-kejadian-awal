...
<div class="row mb-4">
    <div class="col-md-4 mb-3">
        ...
        <input type="text" class="form-control" id="nama_pelapor" name="nama_pelapor" value="<?php echo e(auth()->user()->nama); ?>"
            readonly required>
    </div>
    <div class="col-md-4 mb-3">
        ...
        <select class="form-select" id="jabatan_pelapor" name="jabatan_pelapor" required>
            <option value="Master/Nakhoda" <?php if(auth()->user()->jabatan == 'Master/Nakhoda'): ?> selected <?php endif; ?>>Master/Nakhoda
            </option>
            <option value="C/O (Chief Officer)" <?php if(auth()->user()->jabatan == 'C/O (Chief Officer)'): ?> selected <?php endif; ?>>C/O
                (Chief Officer)</option>
            <option value="2nd Officer" <?php if(auth()->user()->jabatan == '2nd Officer'): ?> selected <?php endif; ?>>2nd Officer</option>
            <option value="3rd Officer" <?php if(auth()->user()->jabatan == '3rd Officer'): ?> selected <?php endif; ?>>3rd Officer</option>
        </select>
    </div>
    <div class="col-md-4 mb-3">
...
<div class="row mb-4">
    <div class="col-md-4 mb-3">
        ...
        <select class="form-select" id="jenis_kapal" name="jenis_kapal" required>
            <option value="KM (Kapal Motor)" <?php if(auth()->user()->jenis_kapal == 'KM (Kapal Motor)'): ?> selected <?php endif; ?>>KM
                (Kapal Motor)</option>
            <option value="MV (Motor Vessel)" <?php if(auth()->user()->jenis_kapal == 'MV (Motor Vessel)'): ?> selected <?php endif; ?>>MV
                (Motor Vessel)</option>
            <option value="MT (Motor Tanker)" <?php if(auth()->user()->jenis_kapal == 'MT (Motor Tanker)'): ?> selected <?php endif; ?>>MT
                (Motor Tanker)</option>
            <option value="SPOB (Self Propeller Oil Barge)" <?php if(auth()->user()->jenis_kapal == 'SPOB (Self Propeller Oil Barge)'): ?> selected <?php endif; ?>>SPOB (Self Propeller Oil Barge)</option>
            <option value="LCT (Landing Craft Tanker)" <?php if(auth()->user()->jenis_kapal == 'LCT (Landing Craft Tanker)'): ?>
            selected <?php endif; ?>>LCT (Landing Craft Tanker)</option>
            <option value="TB (TUG Boat)" <?php if(auth()->user()->jenis_kapal == 'TB (TUG Boat)'): ?> selected <?php endif; ?>>TB (TUG
                Boat)</option>
            <option value="BG (Barge)" <?php if(auth()->user()->jenis_kapal == 'BG (Barge)'): ?> selected <?php endif; ?>>BG (Barge)
            </option>
            <option value="FC (Floating Crane)" <?php if(auth()->user()->jenis_kapal == 'FC (Floating Crane)'): ?> selected <?php endif; ?>>
                FC (Floating Crane)</option>
            <option value="KLM (Kapal Layar Motor / Yacth)" <?php if(auth()->user()->jenis_kapal == 'KLM (Kapal Layar Motor / Yacth)'): ?> selected <?php endif; ?>>KLM (Kapal Layar Motor / Yacth)</option>
        </select>
    </div>
    <div class="col-md-4 mb-3">
