...
<?php $__env->startSection('title', 'Buat Laporan Kejadian'); ?>
<?php $__env->startSection('page-title', 'Form Laporan Kejadian Awal'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body p-4">
            <form action="<?php echo e(route('laporan.store')); ?>" method="POST" enctype="multipart/form-data" id="report-form">
                <?php echo csrf_field(); ?>

                <div class="form-step active" id="step-1">
                    <?php echo $__env->make('laporan.partials.form-halaman-satu', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\PKL\sistem_kejadian_awal\resources\views/laporan/create.blade.php ENDPATH**/ ?>