...
<head>
    ...
    <title>Edit Laporan Kejadian - {{ config('app.name', 'Laravel') }}</title>
                        ...
                        <form action="{{ route('laporan.update', $laporan) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_pelapor" name="nama_pelapor" value="{{ old('nama_pelapor', $laporan->nama_pelapor) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <select class="form-select" id="jabatan_pelapor" name="jabatan_pelapor" required>
                                        <option value="Master/Nakhoda" {{ old('jabatan_pelapor', $laporan->jabatan_pelapor) == 'Master/Nakhoda' ? 'selected' : '' }}>Master/Nakhoda</option>
                                        <option value="C/O (Chief Officer)" {{ old('jabatan_pelapor', $laporan->jabatan_pelapor) == 'C/O (Chief Officer)' ? 'selected' : '' }}>C/O (Chief Officer)</option>
                                        <option value="2nd Officer" {{ old('jabatan_pelapor', $laporan->jabatan_pelapor) == '2nd Officer' ? 'selected' : '' }}>2nd Officer</option>
                                        <option value="3rd Officer" {{ old('jabatan_pelapor', $laporan->jabatan_pelapor) == '3rd Officer' ? 'selected' : '' }}>3rd Officer</option>
                                    </select>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="tel" class="form-control" id="telepon_pelapor" name="telepon_pelapor" value="{{ old('telepon_pelapor', $laporan->telepon_pelapor) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="jenis_kapal" name="jenis_kapal" value="{{ old('jenis_kapal', $laporan->jenis_kapal) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama_kapal" name="nama_kapal" value="{{ old('nama_kapal', $laporan->nama_kapal) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="bendera_kapal" name="bendera_kapal" value="{{ old('bendera_kapal', $laporan->bendera_kapal) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="grt_kapal" class="form-label">Berat Kotor <span class="fst-italic">(GRT)</span> <span class="text-danger">*</span></label>
                                    <input type="number" class="form-control" id="grt_kapal" name="grt_kapal" value="{{ old('grt_kapal', $laporan->grt_kapal) }}" required>
                                </div>
                                <div class="col-md-4 mb-3">
                                    <label for="imo_number" class="form-label">IMO Number / Tanda Selar <span class="fst-italic">(Optional)</span></label>
                                    <input type="text" id="imo_number" name="imo_number" class="form-control" value="{{ old('imo_number', $laporan->imo_number) }}">
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pelabuhan_asal" name="pelabuhan_asal" value="{{ old('pelabuhan_asal', $laporan->pelabuhan_asal) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="waktu_berangkat" name="waktu_berangkat" value="{{ old('waktu_berangkat', \Carbon\Carbon::parse($laporan->waktu_berangkat)->format('Y-m-d\TH:i')) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="pelabuhan_tujuan" name="pelabuhan_tujuan" value="{{ old('pelabuhan_tujuan', $laporan->pelabuhan_tujuan) }}" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="estimasi_tiba" name="estimasi_tiba" value="{{ old('estimasi_tiba', \Carbon\Carbon::parse($laporan->estimasi_tiba)->format('Y-m-d\TH:i')) }}" required>
                                </div>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="posisi_lintang" name="posisi_lintang" value="{{ old('posisi_lintang', $laporan->posisi_lintang) }}" placeholder="Contoh: 3°18'59.1&quot;S" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    <label for="posisi_bujur" class="form-label">Longitude (Bujur) <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="posisi_bujur" name="posisi_bujur" value="{{ old('posisi_bujur', $laporan->posisi_bujur) }}" placeholder="Contoh: 114°35'24.2&quot;E" required>
                                </div>
                                <div class="col-12">
                            ...
                            <div class="row mb-4">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control" id="tanggal_laporan" name="tanggal_laporan" value="{{ old('tanggal_laporan', \Carbon\Carbon::parse($laporan->tanggal_laporan)->format('Y-m-d\TH:i')) }}" required>
                                </div>
