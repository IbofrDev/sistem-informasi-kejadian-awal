            ...
            <div class="modal-content">
                <form method="post" action="{{ route('profile.destroy') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="password-delete" class="form-label">{{ __('Password') }}</label>
                            <input id="password-delete" name="password" type="password" class="form-control" placeholder="{{ __('Password') }}">
                        </div>
                    </div>
